...
def create_order(request):
    ...
    logger.info(
        f"Creating order for user {request.user_id} with data: {request.data}")

    # Ізалікаєм данні з запроса
    ...
    try:
        with transaction.atomic():
            ...
            # Отримуємо інформацію о користувачі
            ...
            try:
                ...
                logger.error(
                    f"Failed to create order, releasing products: {e}")
...
def update_order_status(request, pk):
    '''Оновлення статуса замовлення(для адміна)'''
    ...
    if serializer.is_valid():
        ...
        # Перевіряємо валідность перехода статуса
        ...
        # Публікуємо подію про новий статус
        ...
        # Якшо замовлення відмінено освобождаєм товари
...
def is_valid_status_transition(old_status: str, new_status: str) -> bool:
    '''Перевірка валіддності перехіда статуса замовлення'''
    valid_transitions = {
